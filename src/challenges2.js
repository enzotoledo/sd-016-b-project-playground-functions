...
function generatePhoneNumber(createPhoneNumber) {
  ...
  else if (createPhoneNumber.every(numberBigOrLow) === false) {
    return "não é possivel um número de telefone com esses valores";
  }
  else if (testRepeat(createPhoneNumber) === false) {
    return "não é possivel um número de telefone com esses valores";
  }
  else {
